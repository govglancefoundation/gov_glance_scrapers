...
def main():
    url = 'https://evers.wi.gov/Pages/Newsroom/Press-Releases.aspx'   #url
    table = 'Wisonsin'   
    ...
    notification_title = 'Wisonsin State Updates'       # Notification title
    ...
    content , response = resp.request_render(tag_name ='div.pressReleases li', headers=headers)
    data = []
