...
def main():
    url = 'https://governor.wv.gov/_layouts/15/feed.aspx?xsl=1&web=%2FNews&page=c523c461-c671-42a0-8f03-1f3de1bab595&wp=b9690675-f26b-470a-b54c-020930cda60e' 
    table = 'West Virginia'                           # State name
    ...
    notification_title = 'West Virginia State Updates'    # Notification title
