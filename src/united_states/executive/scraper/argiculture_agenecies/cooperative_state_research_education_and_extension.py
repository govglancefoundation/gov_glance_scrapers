...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=cooperative-state-research-education-and-extension-service"
    table = 'environment'
    ...
    agency_name = 'Cooperative State Research, Education, and Extension Service'
