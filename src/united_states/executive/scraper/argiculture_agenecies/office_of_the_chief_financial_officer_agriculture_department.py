...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=procurement-and-property-management-office-of"
    table = 'environment'
    ...
    agency_name = 'Office of the Chief Financial Officer, Agriculture Department'
