...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=inspector-general-office-agriculture-department"
    table = 'environment'
    ...
    agency_name = 'Inspector General Office, Agriculture Department'
