...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=partnerships-and-public-engagement-office"
    table = 'environment'
    ...
    agency_name = 'Partnerships and Public Engagement Office'
