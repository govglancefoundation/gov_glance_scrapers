...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=food-safety-and-inspection-service"
    table = 'environment'
    ...
    agency_name = 'Food Safety and Inspection Service'
