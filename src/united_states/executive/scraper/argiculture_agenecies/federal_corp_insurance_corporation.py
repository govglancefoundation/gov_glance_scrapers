...
def main():
    url = "https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=federal-crop-insurance-corporation"
    table = 'environment'
    ...
    agency_name = 'Federal Crop Insurance Corporation'
